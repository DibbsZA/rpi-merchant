...
export class DatabaseService {
    ...
    processorCollection: AngularFirestoreCollection<Processor>;
    processorDocument: AngularFirestoreDocument<Node>;
    ...
    constructor(private afs: AngularFirestore) {
        ...
        this.processorCollection = this.afs.collection('processors');
    }
